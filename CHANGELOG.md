...
- Operators: presentation escaping uses the existing Markdown parser; tables, fenced examples, assessment and coverage gates remain unchanged. No database migration is required.
