...
export type Provider = {
   ...
   * per-org config from prisma directly (acp, opencode, claude-code, local,
   * ollama with org-level baseUrl override). Most providers ignore both
   * extras and just use `params`; TypeScript permits implementations to omit
   * trailing parameters from their signature.
   */
